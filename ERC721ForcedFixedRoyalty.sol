...
contract ERC721FR is ERC721Enumerable, Ownable {
    
    using SafeMath for uint256;
    using Address for *;
    
    uint256 public mintingPrice = .001 ether;
    uint256 public royaltyPrice = .001 ether;
    uint256 public mintingPerTxLimit = 20;
    uint256 public mintingStartTimestamp;
    mapping(address => uint256) public numPurchased;

    uint256 public maxSupply = 10000;
    address public creator = 0x7FDF5fbf921e7A8089986895C34939d6338110ED;
    
    string public baseURI;
    
    constructor(string memory _uri) ERC721("ERC721 Fixed Royalty", "ERC721FR") {
        baseURI = _uri;
    }
    ...
    */
    ...
    function setRoyaltyPrice(uint256 newRoyaltyPrice) public onlyOwner {
    ...
    /**
     * Override transfer function to enforce fixed unit royalty
     */
    ...
    function safeTransferFrom(
        ...
        require(!to.isContract(), "cant send to contract");
        require(msg.value >= royaltyPrice, "must transfer acceptable royalty to owner");
